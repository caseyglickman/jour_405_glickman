...
**Over the past two years there has been a general decrease in the number of car thefts. From 2023 to the middle of 2024, car thefts were steadily decreasing. Then there was a spike in the middle of 2024, the rate plateaued for a bit but since then the rates have been decreasing again  **
...
- What does the 95% confidence interval show here? **a 95% confidence interval means that if you were to repeat this data collecting process there is a 95% of the car thefts would fall into this range of data :**

- What figure(s) accurately reflects the number of car thefts in a typical month? **the mean which is 460.4 reflects the number of car thefts in a typical month**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **Car thefts in Prince George's County are on the decline**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **the p-value is .179 and since that is greater than .05 the results are not statistically significant. This means we can't reject the null hypothesis.**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **I would change my headline to focus on the fact that car theft rates have actually stayed consistent over the past 2 years. I would tell me editor that although the car theft rates are currently lower than they were in 2023, the overall trend shows that rates have stayed the same in recent years. I would expect my editor to ask what the story angle here is since there are not any major changes. I think that the story could focus efforts PG county is making to decrease car thefts, or the lack of action they have taken to adress this problem**
