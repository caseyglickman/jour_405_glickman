...
**The spike year has the highest mean rate at 59.9 and median rate at 58.1. The post-spike time period has the second highest rates and the pre-spike period has the lowest rates. This data suggests that during 2023 car thefts were happening at a faster rate than before and after 2023.**: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
**This chart shows the car thefts rate changing from 201 to 2025 including the spike in car rates in 2023. a more active title would be: How a spike in car theft rates in 2023 has affected overall monthly car theft rates in PG county**
...
- **Null Hypothesis (H0)**:there is no significant difference between the pre and post spike year of car theft rates

- **Alternative Hypothesis (H1)**: there is a significant differnce between the pre and post spike year car rate thefts
...
**the f value is large and the p value is very small. Since the p value is smaller than .05, this means that the results are statistically significant. Since the f value is large, we know that the means differ across time periods, and that difference is more statically significant that average difference within each time period **
...
**The Tukey test shows us that there is a significant difference between the three time periods. Even though car rate thefts fell after the spike year, they remained higher than the initial levels pre spike which shows that there is a statically significant impact of the spike in 20023.
Headline:Car Thefts Remain Elevated After Spike in 2023 
Lede:Car theft rates rose sharply in 2023 and although they declined afterward, they have not returned to pre-2023 levels. The post-spike period still shows statically significantly higher theft rates than before the spike, suggesting the spike has had a lasting impact**