...
** education levels in survey samples might differ from the general population because people responding to a survey might be more likely to have a job from a higher education that gives them the flexibility to take the time and respond to a survey. people with lower education levels are more likely to work multiple jobs and might be struggling to make ends meet and therefore would not prioritize taking this type of survey **
...
** Having a college degree increases likelihood of voting **
...
**The percentage for high school or less changed after applying the weights. We now see that there is a lower percentage of people with a high school degree or less said yes to voting and a higher percentage of those people said no to voting **

2. Why might the weighted results be considered more accurate than the unweighted results?

**weighted results might be more accurate than unweighted results because weighted results account for differences between the sample and the overall population. Weighting assigns greater influence to responses from underrepresented groups and less influence to over represented ones so it can provide a more accurate representation of what the real results will look like**
...
**It is important for journalists to understand survey weighting so that they can accurately report on polls and let their readers know if a group might be over or under represented in the polls and therefore the results might be slightly inaccurate**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**The weighted data shows us that people with a lower education were actually more likely to not vote than the unweighted data predicted. Since I was already going to report the story focusing on how people with a college degree are more likely to vote, this does not affect my angle of the story but it does help to further prove this correlation between education and voter turnout**
...
**I would want to know the specifics of how the weights were calculated. How many people were equal to one person with a high school degree and how many people were equal to a person with a college degree? this would help us understand the extent to which groups were underrepresented versus over repersented in the survey**
