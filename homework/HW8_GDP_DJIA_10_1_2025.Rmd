...
GDP_data |> 
  ...
  geom_smooth(aes(x=GDP, y=DJIA), method="lm") + labs(title = "Relationship between GDP and DJIA",  x = "Gross Domestic Product" ,  y = "Dow Jones Industrial Average")
...
There is a strong positive correlation between the DJIA and GDP. The scatterplot shows that as the stock market gets stronger so does teh overall econmoy. there is some variation to this trend, but overall there is a string positive correlation between the stock market and the overall state of the economy. 
