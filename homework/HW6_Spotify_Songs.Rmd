...
The data is skewed slightly to the left meaning that more songs have a danceability score higher than the mean which is 0.673. Since the standard deviation is so low we know that the data has very little variance and is heavily clustered around the mean. Pitch: American 
rap artist and singer, Gunna is ranked in the top two songs with the highest danceability scores in 2020. His song "Fox 5" received the highest danceability score at a 0.975 and his song "Codeine" coming in at a close second.  
