...
**As FARMS percentage increases, the percent of students that have met or exceeded math expectations slightly increases. However, overall there is a weak positive correlation**
...
**This model is not worth using. The p-value is .1125 which is greater that .05, so it is insignificant. The Adjusted R-squared value is 0.0254 which is far from 100 and therefore also insignificant. This tells us that there is not a significant relationship between FARMS percentage and math scores**
...
**The largest differences between the predicted result and the actual math scores is 34.9 at Whitemarsh elementary school, 31.4 at Gulph and 31.1 at Crooked Billet. Since these schools have a high residual there is a lot of variance between the predicted result and the actual result.**
...
**From this model we have come to the conclusion that there is a weak positive correlation between students on free and reduced lunches and their ability to do better on standardized math tests. Since the p-value is .1125 and the adjusted R-squared value is 0.0254, we know that these results are not significant. With this insignificant weak positive correlation we can not make the assumption that elementary schools with fewer students on free and reduced price meals do better on standardized math tests and our story should reflect that**
