...
**Overall the daily calls stays pretty consistent throughout the year fluxating up and down. In the winter months the number of calls dips slightly.**
...
**The unusual days highlight the outliers in the data set. These unusual days show particularly high number of phone calls and low number of phone calls throughout the year. In task 3 we said that there is a decrease in the number of phone calls in the winter months. We can see this reflected in the graph because the winter months have more usually low calls.**
...
**Tuesday has the highest z-score at 3.31. Since this z-score is unusually high we know that Tuesday was an outlier day where the number of calls was far away from the mean. We can say that Tuesday represented a day with an unusually high number of 911 phone calls.**
...
**One angle for this story could focus on the fact that winter months have a lower number of 911 calls. My story could look into why winter months have a lower number of 911 calls compared to the rest of the year. Next steps would include looking into the 911 calls that occur during the winter months to identifying themes in what people are calling to report about. Then I would do the same analysis for the summer months to see what might be happening in the other months to cause more 911 calls. Are people staying inside more during the cold months so less 911 related incidents are occurring?**
