...
**Task 3: Private colleges have the highest SAT scores, public colleges have the second highest average SAT scores and community colleges have the lowest SAT scores.**
...
Yes because the p values are all very low. The p value is .001 which is below the significance level of .05. This proves that the data is statistically significant

2. Which specific college types differ from each other?
All three colleges types have different average SAT scores. For instance, the private and community colleges differ by 366.96. The F-statistic found that the differences between colleges types is more significant than differences within these college groups

3. How large are these differences?
Private colleges have the highest SAT scores at an average of 1435.026, this is 366.96 points higher than community colleges on average. Public colleges have the second highest average SAT scores which is 292.55 points higher than community colleges. Lastly the difference between the public colleges and the private colleges is 74.40. 
...
Students at private colleges score higher on the SAT than public school students

Private colleges are more likely to have students with higher average SAT scores. On average, private school students have an SAT score of 1435 while public college students are more likely to score lower on the SAT with an average of 1361. 