...
One concerning thing we found in the appendix is that respondents who identified as having more than one ethnic background were lumped into a category all together called multiracial. The Races/Ethnicities with Small Sample Sizes category also raises some concern because this category puts a wide variety of small ethic groups together including respondents who identified as Alaska Native, American Indian/Native American/Indigenous, Levantine/Middle Eastern/Southwest Asian/North African (SWANA), Native Hawaiian, Pacific Islander, and Jewish. Lastly, we noted the gender expansive group. This category also raises some concerns because we are putting groups who have different identities into one category. The gender expansive group included those who indicated they were genderfluid, non-binary, transgender, and/or wrote in another gender identity. 
**
...
1. What is the range of weights in this dataset? **0.2298 to 3.0386**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **a weight of .23 would mean that a person is over represented meaning that one respondent counts as 4 people and a weight of 3.05 means that the person is under represented **

3. Why might some respondents be weighted more heavily than others? **some respondents might be weighted more heavily because they are less likely to respond or because there is less data available for that category of people and therefore the individual responses need to be weighted more heavily to represent the whole population **
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **the rarely/never category:**

2. How might these differences affect reporting on likely voter turnout? *The number of people who said they rarely/never voted was underrepresented. The yes percentage difference for the rarely/never category was -3.56% and the no percentage difference was 1.99%. This means that voter turnout could actually be innacurate on election day **

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **The people who rarley/never vote are under represented because after that group was weighted the rates went down. this makes sense because people who are not engaged in voting might also not be engaged to answer these polling questions **
