...
No they are not statically justified. For all three of the samples, when you take the margin of error into account there is no majority. For instance, with a sample size of 100 with margin of error of 10% then it becomes between 42% and 62% which does not show a majority

--  What alternative headline would be more accurate?
Approximately half of citizens support new city policy
...
A new transit line has increased home values, according to stataically signifiacnt data found regaurding average housing prices. Prior to the transit line being built average housing prices were  $285000. After the transit line, the average housing prices increased to an average of $304500, showing an increase after teh transit line was built. 
