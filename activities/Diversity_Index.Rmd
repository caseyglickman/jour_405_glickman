...
**Baltimore city, Bowie city and Edgewood. all of these cities have a fairly even number of white and black residents so there is high diversity **
...
**Summerfield has the highest race probability at .87. This means that this city is not diverse and two randomly chosen people have a high likelihood of being the same race. For Summerfield there is a high black population, 11565 out of 12403 are black **
...
**Cities with a lowest Hispanic probability have a low Hispanic population. These cities also have a low race probability which is interesting because that shows there is high racial diversity**
...
**Langley Park, Wheaton and Adelphi have the highest diversity index. Lake Shore is the least diverse.**
...
**Headline: Prince George's County home to Maryland's most diverse cities. Lede: Prince George's County cities, Langley Park and Adelphi, are among the top three cities in Maryland with the highest diversity according to data from the USA TODAY Diversity Index which measures the likelihood that two randomly selected residents will be the same race. Details: For this story I would look deeper into historical trends in Langley Park and Adelphi to see how diversity levels have fluctuated over time. I would also talk to residents about ways they see diversity reflected in their community and whether they think high diversity leads to segregation between groups or a broader cultural acceptance within the city.**
